...
- `0x07` CMD_SERVO_CONTROL: payload `<uint8 id><int16 angle><uint16 time_ms>`
  - `angle`: 0-270°
  - `time_ms`: rotation duration in milliseconds (e.g., 1000 = 1s)
...
Packed, little-endian, total 91 bytes.
...
| req_servo[10] | uint16[10] | 20 | 0-270° request angles |
| servo[10] | uint16[10] | 20 | 0-270° measured angles |
| speedLimit | uint8 | 1 |
| req_speedL | float | 4 |
| req_speedR | float | 4 |
| speedL | float | 4 |
